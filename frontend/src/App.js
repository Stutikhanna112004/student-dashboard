...
// ─── Auth check ───────────────────────────────────────────────────────────────
// If no username in sessionStorage the user hasn't logged in this session.
// We redirect them to /login instead of hitting the API and getting a 401.
function isLoggedIn() {
...
// If not logged in → redirect to /login (preserves the intended destination).
...
export default function App() {
  return (
    <Routes>
      ...
      {/* Root redirect — send "/" to "/login" if not logged in */}
      <Route
        path="/"
        element={
          <RequireAuth>
      ...
      {/* All protected routes inside the sidebar shell */}
      <Route
        path="/*"
        element={
          <RequireAuth>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        padding: "24px 16px", borderRight: "1px solid #1e293b",
        ...
        <div style={{ marginBottom: 36, paddingLeft: 8 }}>
          ...
          <span style={{
            display: "block", fontSize: 11, color: "#334155",
