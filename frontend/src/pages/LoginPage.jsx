...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Parse even error responses — Django returns JSON
      let json;
      try { json = await res.json(); } catch { json = {}; }

      if (res.ok && json.success) {
        // Small delay so the browser has time to commit the Set-Cookie header
        // before the next fetch fires in useDashboard
      ...
      setError(`Cannot reach server — check REACT_APP_API_URL (${API_BASE})`);
      triggerShake();
    } finally {
      setLoading(false);
    }
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <div style={{ marginBottom: 20 }}>
                ...
                <input
                  ...
                  autoComplete="username" autoFocus placeholder="your_username"
                  style={inputStyle}
