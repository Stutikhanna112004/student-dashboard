...
export default function LoginPage() {
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#050a18", display:"flex", alignItems:"center",
      ...
      <div style={{ position:"relative", zIndex:1, width:"100%", maxWidth:420, padding:"0 24px" }}>
        <Reveal>
          <div style={{ display:"flex", flexDirection:"column", alignItems:"center", marginBottom:36 }}>
            ...
            <h1 style={{ marginTop:20, marginBottom:6, fontSize:30, fontWeight:900,
              background:"linear-gradient(135deg, #f8fafc 0%, #38bdf8 55%, #818cf8 100%)",
              WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent" }}>EduPulse</h1>
            <p style={{ color:"#334155", fontSize:13, margin:0, letterSpacing:1 }}>SIGN IN TO YOUR DASHBOARD</p>
          </div>
        </Reveal>
        <Reveal delay={0.12}>
          <div style={{ background:"rgba(15,23,42,0.82)", border:"1px solid rgba(56,189,248,0.14)",
            ...
            <p style={{ textAlign:"center", color:"#1e3a52", fontSize:13, marginTop:24, marginBottom:0 }}>
              No account?{" "}
              <a href={`${API_BASE}/signup/`} style={{ color:"#38bdf8", textDecoration:"none", fontWeight:700 }}>
                Register via Django
              </a>
            </p>
          </div>
...
const labelStyle = { display:"block", color:"#475569", fontSize:11, textTransform:"uppercase",
  letterSpacing:1.4, marginBottom:8, fontFamily:"'Courier New', monospace" };
const inputStyle = { width:"100%", padding:"12px 14px", background:"rgba(255,255,255,0.04)",
  border:"1px solid rgba(255,255,255,0.08)", borderRadius:10, color:"white", fontSize:14,
  outline:"none", transition:"border-color .2s, box-shadow .2s", fontFamily:"'Courier New', monospace" };
function Spinner() {
